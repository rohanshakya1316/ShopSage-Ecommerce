...
const ImageShowcase = ({ images, name, stock }) => {
  const [activeImage, setActiveImage] = useState(images[0]);
  const lowStock = stock !== undefined && stock < 10;

  return (
    <div className="flex flex-col gap-4">
      <div className="relative bg-white rounded-2xl h-96 md:h-120 flex items-center justify-center overflow-hidden border border-slate-200 p-6">
        <Image
          width={800}
          height={800}
          src={activeImage}
