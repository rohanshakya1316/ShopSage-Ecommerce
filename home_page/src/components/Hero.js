export default function Hero() {
  return (
    <section id="hero"  className="bg-gradient-to-r from-slate-900 via-indigo-900 to-slate-900 min-h-screen flex items-center">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -top-2 -left-5 bg-amber-400 text-slate-900 px-6 py-4 rounded-xl shadow-lg font-bold">
              🎉 30% OFF
            </div>

            {/* Floating Delivery Card */}
            <div className="absolute -bottom-5 -right-5 bg-white p-4 rounded-xl shadow-xl">
